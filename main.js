...
if ("https://www.vinodjangid.site/" === currentURL) {
  var e,
    t = document.getElementById("footer-wala-avatar");
  (document.getElementById("nav-avatar").src =
    "https://github.com/vinodjangid07/vinodjangid07/assets/86096184/6822c251-7853-48da-986d-fc70b835f1d9"),
    (t.src =
      "https://github.com/vinodjangid07/vinodjangid07/assets/86096184/bd54765f-b277-482a-a256-cd305b3abbe6");
}
function visualmode() {
...
window.addEventListener("scroll", () => {
  ...
  console.log(
    "%c Designed and Developed by Maze Technologies ",
